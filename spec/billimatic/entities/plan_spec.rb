...
describe Billimatic::Entities::Plan do
  ...
  it_behaves_like "entity_attributes", [
                    ...
                    :readjustment_days_until_update, :billet_notification_ruler_id,
                    :payment_gateway_notification_ruler_id,
                    :emites_service_values_id, :emites_service_value_name,
                    :cobrato_billet_charge_config_id,
                    ...
                    :myfinance_billet_sale_account_id,
                    :myfinance_billet_sale_account_name,
                    :myfinance_payment_gateway_sale_account_id,
